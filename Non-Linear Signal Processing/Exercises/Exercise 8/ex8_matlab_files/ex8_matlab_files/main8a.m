...
%%  Running for different K

plot_motion=0; %avoid plots during loop
...
%       clear 
    ...
    subplot(2,1,1),plot(1:Ntrain,that_train,'r',1:Ntrain,ttrain,'b')
    title('sunspot training set')
    prediction_test_error = [prediction_test_error test_error];
    prediction_train_error = [prediction_train_error train_error];
    density_test_error = [density_test_error Etest_arr(t)];
    density_train_error = [density_train_error Etrain_arr(t)];
